...
export const PropertyCard: React.FC<PropertyCardProps> = ({
  ...
  return (
    <TouchableOpacity
      ...
      accessibilityLabel={`Visualizza dettagli per ${t('property_category.'+property.propertyCategory)} in ${property.address?.city || 'N/A'}, ${t('property_status.'+property.status)}`}
    >
      <Image
      ...
      <ThemedView className="p-4" style={{ backgroundColor }}>
        <ThemedText 
          ...
          darkColor={textColor}
        >
            {t('property_category.'+property.propertyCategory)} in {property.address?.city || 'N/A'}, {t('property_status.'+property.status)}
        </ThemedText>
