...
Nelle sezioni seguenti, vengono analizzati quattro esempi di metodi testati, illustrando le strategie adottate per la progettazione, tra cui le classi di equivalenza individuate e coperte e i criteri di copertura strutturale per ogni singolo esempio.
\clearpage
...
La checklist è stata applicata sistematicamente a tutte le principali funzionalità dell'applicazione, dalla registrazione alla gestione delle offerte. I risultati sono riassunti nella tabella seguente. TODO controllare se corretto
...
TODO aggiungere screenshot del report
