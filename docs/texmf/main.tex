...
Il front-end è realizzato in \textbf{React Native} per garantire un'esperienza utente fluida e reattiva, perfettamente adattabile a dispositivi e sistemi operativi diversi, con un look nativo e ben integrato con l'ambiente operativo.\\
React-Native permette e promuove inoltre lo sviluppo di interfacce utente modulari e riutilizzabili, facilitando la manutenzione e l'evoluzione del codice nel tempo.\\
Il linguaggio scelto è \textbf{TypeScript}, che si integra perfettamente con React Native e offre buone garanzie in termini di manutenzione del codice, modularità e riduzione degli errori grazie al suo sistema di tipi statici; È inoltre un linguaggio tra i più popolari.
...
I test automatici sono stati realizzati utilizzando JUnit per il back-end e TODO per il front-end, coprendo le funzionalità principali e verificando la correttezza del comportamento del sistema.\\
